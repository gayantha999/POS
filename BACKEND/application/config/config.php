...
|
*/
$config['base_url'] = 'http://localhost/POS/POS/BACKEND';
...
$config['sess_driver'] = 'files';
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200; // Session expires after 2 hours
$config['sess_save_path'] = NULL; // Default path for file storage (ensure writable directory if using 'files')
$config['sess_match_ip'] = FALSE;
